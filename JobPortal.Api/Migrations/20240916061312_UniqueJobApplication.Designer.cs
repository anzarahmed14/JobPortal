...
namespace JobPortal.Api.Migrations
{
    ...
    [Migration("20240916061312_UniqueJobApplication")]
    partial class UniqueJobApplication
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("JobPortal.Model.ExportLevel", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<string>("ExportLevelName")
                        .IsRequired()
                    ...
                    b.HasIndex("ExportLevelName")
                        .IsUnique();

                    b.ToTable("ExportLevels");
                });

            modelBuilder.Entity("JobPortal.Model.Job.JobApplication", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("JobPortal.Model.Job.JobCity", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("JobPortal.Model.Job.JobInfo", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("JobPortal.Model.Job.JobSkill", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("JobPortal.Model.Role", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("JobPortal.Model.SkillInfo", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
            ...
            modelBuilder.Entity("JobPortal.Model.Job.JobApplication", b =>
                {
                    b.HasOne("JobPortal.Model.Job.JobInfo", "JobInfo")
                        .WithMany()
                        .HasForeignKey("JobId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("JobPortal.Model.SkillInfo", b =>
                {
                    b.HasOne("JobPortal.Model.ExportLevel", "ExportLevel")
                        .WithMany()
            ...
            modelBuilder.Entity("JobPortal.Model.User", b =>
                {
                    b.HasOne("JobPortal.Model.Role", "Role")
                        .WithMany()
